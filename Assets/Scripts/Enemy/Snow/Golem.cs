...
public class Golem : Enemy
{
    ...
    private Vector3 initialPosition; // Vị trí ban đầu của Golem
    ...
    /// Khi tấn công, Golem sẽ gọi trigger "Attack", và không cho di chuyển cho đến khi animation "GolemAttack" hoàn thành.
    /// </summary>
    ...
    /// <summary>
    /// Coroutine đợi cho đến khi animation "GolemAttack" được chạy và hoàn thành.
    /// </summary>
    private IEnumerator WaitForAttackAnimation()
    {
        // Đợi một frame để đảm bảo trigger đã được xử lý
        yield return null;
        // Chờ cho đến khi trạng thái chuyển sang "GolemAttack"
        while (!animator.GetCurrentAnimatorStateInfo(0).IsName("GolemAttack"))
        {
            yield return null;
        }
        // Đợi cho đến khi animation "GolemAttack" hoàn thành
        while (animator.GetCurrentAnimatorStateInfo(0).IsName("GolemAttack") &&
    ...
    /// <summary>
    /// Lật sprite của Golem dựa trên hướng di chuyển
    /// </summary>
    ...
    private IEnumerator DisappearAfterDelay()
    {
        ...
        Debug.Log("Golem đã biến mất sau 1 giây.");
        Destroy(gameObject);
    }
